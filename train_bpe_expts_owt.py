...
def main():
    ...
    # Configuration
    input_path = Path('/home/ubuntu/assignment1-basics/data/owt_train.txt')

    vocab_size = 32000  # Common vocab size for small models
    special_tokens = ["<|endoftext|>"]

    # Check if file exists
    if not input_path.exists():
        print(f"\n✗ Error: Input file not found at {input_path}")
        print("\nPlease ensure the OpenWebText dataset is in the correct location.")
        return 1
    ...
    try:
        ...
        vocab_file = output_dir / 'openwebtext_vocab.json'
        merges_file = output_dir / 'openwebtext_merges.txt'
